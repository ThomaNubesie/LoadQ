...
// Passenger ↔ driver direct message. Reached from "Message driver" on My trip.
// Distinct from (passenger)/messages.tsx, which is the LoadQ Support channel
// used by the Board and Profile message entry points.
export default function PassengerThreadScreen() {
  ...
  const call = () => {
    if (!phone) { Alert.alert(t("noPhoneNumber"), t("noPhoneNumberDesc")); return; }
