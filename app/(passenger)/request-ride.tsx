...
const s = StyleSheet.create({
  ...
  chipOn:     { borderColor: Colors.accentP, backgroundColor: "rgba(76,130,240,0.12)" },
  ...
  interac:    { backgroundColor: "rgba(76,130,240,0.10)", borderWidth: 1, borderColor: "rgba(76,130,240,0.4)", borderRadius: 14, padding: 14, marginTop: 16 },
